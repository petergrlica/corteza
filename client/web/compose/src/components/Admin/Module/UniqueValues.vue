      ...
      <div class="mt-3">
        ...
        >
          ...
          <tbody v-if="rule.constraints">
            ...
            >
              <td>{{ getFieldLabel(constraint) }}</td>
...
export default {
  ...
  methods: {
    ...
    getFieldLabel (constraint) {
      return this.getField(constraint.attribute).label || this.getField(constraint.attribute).name
    },
